...
class CustomAlerts {
  ...
  Future<FunctionResponse> confirmDelete(
      {required BuildContext context, required bool isBookDelete}) async {
    final ThemeData theme = Theme.of(context);
          ...
          builder: (ctx) {
            return AlertDialog(
              content: Column(
                ...
                children: [
                  Text(
                    'Delete ${isBookDelete ? 'Book' : 'Entry'}',
                    style: theme.textTheme.headline3,
                  ),
                  const SizedBox(height: 10),
                  Text(
                      'Are you sure you want to delete? This ${isBookDelete ? 'book' : 'entry'} will be deleted permanently.'),
                  const SizedBox(height: 10),
                  Row(
